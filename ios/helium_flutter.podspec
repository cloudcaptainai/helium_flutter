...
A Flutter plugin that integrates the Helium SDK for iOS.
  ...
  s.dependency 'Helium', '2.0.2' # note that the dependency in Package.swift is what's actually used... we might be able to remove this but safer to keep in for now
  s.platform = :ios, '14.0'
